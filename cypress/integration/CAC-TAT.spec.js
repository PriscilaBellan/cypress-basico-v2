...
describe('Central de Atendimento ao Cliente TAT', function() {
  ...
  it('verifica o tí­tulo da aplicação', function() {
  ...
  it('preenche e limpa os campos nome, sobrenome, email e telefone', function(){
    ...
    cy.get('#lastName')
      .type('Bellan')
      .should('have.value', 'Bellan')
      .clear()
      .should('have.value', '')
    cy.get('#email')
      .type('priscilasantosbellan@gmail.com')
      .should('have.value', 'priscilasantosbellan@gmail.com')
      .clear()
      .should('have.value', '')
    cy.get('#phone')
      .type('51999999999')
